...
import static com.example.android.weatherForecastMG.data.WeatherContract.WeatherEntry;
...
public class FakeDataUtils {
    ...
    public static void insertFakeData(Context context) {
        ...
        long today = WeatherForecastDateUtils.normalizeDate(System.currentTimeMillis());

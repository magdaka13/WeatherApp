...
import com.example.android.weatherForecastMG.DetailActivity;
import com.example.android.weatherForecastMG.R;
...
public class NotificationUtils {
    ...
    public static void notifyUserOfNewWeather(Context context) {
        ...
        Uri todaysWeatherUri = WeatherContract.WeatherEntry
                .buildWeatherUriWithDate(WeatherForecastDateUtils.normalizeDate(System.currentTimeMillis()));
        ...
        if (todayWeatherCursor.moveToFirst()) {
            ...
            int largeArtResourceId = ForecastWeatherUtils
            ...
            int smallArtResourceId = ForecastWeatherUtils
             ...
             */
            WeatherForecastPreferences.saveLastNotificationTime(context, System.currentTimeMillis());
        }
    ...
    private static String getNotificationText(Context context, int weatherId, double high, double low) {
         ...
         */
        String shortDescription = ForecastWeatherUtils
        ...
        String notificationText = String.format(notificationFormat,
                shortDescription,
                ForecastWeatherUtils.formatTemperature(context, high),
                ForecastWeatherUtils.formatTemperature(context, low));

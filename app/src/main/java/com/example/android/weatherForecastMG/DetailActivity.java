...
import com.example.android.weatherForecastMG.databinding.ActivityDetailBinding;
import com.example.android.weatherForecastMG.utilities.WeatherForecastDateUtils;
import com.example.android.weatherForecastMG.utilities.ForecastWeatherUtils;
...
public class DetailActivity extends AppCompatActivity implements
     ...
     */
    private static final String FORECAST_SHARE_HASHTAG = " #ForecastWeather";
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        int weatherImageId = ForecastWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherId);
         ...
         * WeatherForecastDateUtils#getFriendlyDateString takes care of this for us.
         */
        long localDateMidnightGmt = data.getLong(INDEX_WEATHER_DATE);
        String dateText = WeatherForecastDateUtils.getFriendlyDateString(this, localDateMidnightGmt, true);
         ...
         * resources using getString rather than using a method from ForecastWeatherUtils as

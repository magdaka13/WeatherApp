 ...
 */
package com.example.android.weatherForecastMG.data;
...
import com.example.android.weatherForecastMG.utils.PollingCheck;
...
import static com.example.android.weatherForecastMG.data.WeatherContract.WeatherEntry.COLUMN_DATE;
import static com.example.android.weatherForecastMG.data.WeatherContract.WeatherEntry.COLUMN_DEGREES;
import static com.example.android.weatherForecastMG.data.WeatherContract.WeatherEntry.COLUMN_HUMIDITY;
import static com.example.android.weatherForecastMG.data.WeatherContract.WeatherEntry.COLUMN_MAX_TEMP;
import static com.example.android.weatherForecastMG.data.WeatherContract.WeatherEntry.COLUMN_MIN_TEMP;
import static com.example.android.weatherForecastMG.data.WeatherContract.WeatherEntry.COLUMN_PRESSURE;
import static com.example.android.weatherForecastMG.data.WeatherContract.WeatherEntry.COLUMN_WEATHER_ID;
import static com.example.android.weatherForecastMG.data.WeatherContract.WeatherEntry.COLUMN_WIND_SPEED;
...
class TestUtilities {
    ...
    static ContentValues[] createBulkInsertTestWeatherValues() {
        ...
        long normalizedTestDate = WeatherForecastDateUtils.normalizeDate(testDate);

        for (int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++) {

            normalizedTestDate += WeatherForecastDateUtils.DAY_IN_MILLIS;
